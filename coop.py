...
class coop:
    """
    Class representing the co-op game mode of tanks. 
    This game involves 2 player tank sprites, and a bunch of enemies. 
    The aim of the game is to work together to kill enemies!
    """
    ...
    def __init__(self, screen, difficulty):
        ...
        if(difficulty == 'easy'):
            self.enemyMin, self.enemyMax = 30, 200
            self.spriteHP = 100
        elif(difficulty == 'medium'):
            self.enemyMin, self.enemyMax = 30, 150
            self.spriteHP = 150
        elif(difficulty == 'hard'): 
            self.enemyMin, self.enemyMax = 20, 120
            self.spriteHP = 200
    ...
    def update(self):
        ...
        """
        # Anything that happens by timed interval happens here, implemented with counters (e.g. ammo, health, enemy spawn)
        ...
        for Tank in self.player1_group:
            for bullet in self.player1_group.sprite.bullets:
                for Sprite in self.enemies:
                    if(pygame.sprite.collide_mask(bullet, Sprite)):
                        ...
                        self.SCORE += 100
                        bullet.kill()
        for Tank in self.player2_group:
        ...
        # Update messages to the screen, re-rendering them, then blit the messages and flip the display
